...
BASECPU=0
PCAP_FILE=""
MAX_BW=""       # Mbps limit; empty means unlimited
BUILD_DIR="build"
...
DPDK_ARGS="--rx \"(0,0,0)\" --tx \"$TXPARAM\" --rsz \"1024, 1024\" --bsz \"144, 144\" --pcap \"${PCAP_FILE}\""
...
# Run the sender with the constructed arguments
